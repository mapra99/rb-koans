...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # shovel operator is shorthand for the #concat method. It is faster because it doesn't create a new object as the sum of the two sumed up objects
  end
  ...
  # It looks like this is no longer true in Ruby 3
